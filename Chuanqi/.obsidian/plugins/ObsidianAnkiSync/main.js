...
rules.mark_open = function(/* tokens, idx, options, env */) {
  return '<text style="background-color: rgba(0,0,0,0); color: #00aaff">';
};
...
function tagReplaceSlash(item, index, arr) {
...
class ReplaceBlock extends Block {
    ...
    async addInAnki() {
        ...
        console.debug(extra);
        // chuanqi: I modified this
        let deck = this.getAttrib("deck") || this.getDocYAMLProp("deck") || "Default";
        console.debug(deck);
        ...
        // chuanqi: I modified here
        yamlTags.forEach(tagReplaceSlash);
        let tags = [...yamlTags];
        console.debug(tags);
